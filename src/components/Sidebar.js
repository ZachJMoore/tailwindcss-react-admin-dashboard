...
class Sidebar extends Component {
  render() {
    return (
      <nav className={"sidebar-container border-r overflow-y-auto w-1/5 bg-cover bg-no-repeat bg-top relative " + (this.props.sidebarIsShown ? "flex" : "hidden")} style={{backgroundImage: `url(${mountainBg})`}}>
